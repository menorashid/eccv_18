...
def make_command_str():
    ...
    train_file_pre = '../data/emotionet/train_test_files_toy/train_'
    test_file_pre =  '../data/emotionet/train_test_files_toy/test_'
    util.mkdir(out_dir)
    exp_name = 'emotionet_toy_diff_aug'
    ...
    aug_more = [['flip']]
    # ,['hs','flip'],['flip','rotate','scale_translate']]
    folds = [[0]]
    ...
    for aug_more, dropout, folds, lr, gpu_id in params_arr:
        ...
        out_dir_pre = os.path.join(out_dir,model_name+'_'+str(route_iter),'emotionet_toy')
