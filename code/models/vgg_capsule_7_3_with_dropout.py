...
from CapsuleLayer_with_dropout import CapsuleLayer,softmax
...
class Vgg_Capsule(Dynamic_Capsule_Model_Super):
    ...
    def __init__(self,n_classes,pool_type='max',r=3,class_weights=None, reconstruct = False, loss_weights = None, std_div = None, dropout = 0):
        ...
        self.features = []
        self.features.append(CapsuleLayer(32, 1, 512, 8, kernel_size=3, stride=2, num_iterations=r, dropout = 0))
...
class Network:
    def __init__(self,n_classes=8,pool_type='max',r=3, init=False,class_weights = None,reconstruct = False,loss_weights = None, std_div = None, dropout = 0):
        # print 'BN',bn
        model = Vgg_Capsule(n_classes,pool_type,r,class_weights,reconstruct,loss_weights, std_div = std_div, dropout = dropout)
