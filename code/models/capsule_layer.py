...
class CapsuleLayer(nn.Module):
    ...
    def __init__(self, in_unit, in_channel, num_unit, unit_size, use_routing,
                 num_routing, cuda_enabled,caps_channels=32,kernel_size=9,stride=2):
        ...
        if self.use_routing:
            ...
            self.conv_units = nn.ModuleList([
                nn.Conv2d(self.in_channel, caps_channels, kernel_size, stride) for u in range(self.num_unit)
            ])
