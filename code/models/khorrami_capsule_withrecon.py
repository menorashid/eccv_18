...
class Khorrami_Capsule_Recon(Dynamic_Capsule_Model_Super):
    ...
    def __init__(self,n_classes,loss,in_size = 224, r=3,):
        ...
        self.conv_base = []
        self.conv_base.append(nn.Conv2d(1, 32, 5, stride=1,padding=2))
        self.conv_base.append(nn.ReLU(True))    
        self.conv_base.append(nn.MaxPool2d(2,2))
        
        self.conv_base.append(nn.Conv2d(32, 64, 5, stride=1,padding=2))
        self.conv_base.append(nn.ReLU(True))
        self.conv_base.append(nn.MaxPool2d(2,2))
        
        self.conv_base.append(nn.Conv2d(64, 128, 5, stride=1,padding=2))
        self.conv_base.append(nn.ReLU(True))
        self.conv_base.append(nn.MaxPool2d(2,2))
        ...
        self.features = []
        self.features.append(CapsuleLayer(32, 1, 128, 8, kernel_size=3, stride=2, num_iterations=r))
        self.features.append(CapsuleLayer(n_classes, 32, 8, 16, kernel_size=5, stride=1, num_iterations=r))
