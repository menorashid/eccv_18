...
class Vgg_Capsule_Disfa_Bigprimary_Recon(Vgg_Capsule_Disfa_Recon):
    ...
    def __init__(self,n_classes,loss,in_size = 224, r=3,):
        ...
        self.features.append(CapsuleLayer(64, 1, 512, 4, kernel_size=3, stride=2, num_iterations=r))
        
        self.features.append(CapsuleLayer(n_classes, 64, 4, 16, kernel_size=6, stride=1, num_iterations=r))
